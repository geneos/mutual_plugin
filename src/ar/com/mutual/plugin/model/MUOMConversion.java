...
public class MUOMConversion extends MPluginPO {
	
	
	public MUOMConversion(PO po, Properties ctx, String trxName, String aPackage) {
...
*/
    ...
    static public BigDecimal getProductRateTo( Properties ctx,int M_Product_ID,int C_UOM_To_ID ) {
    	org.openXpertya.model.MUOMConversion[] rates = getProductConversions( ctx,M_Product_ID );
        ...
        for( int i = 0;i < rates.length;i++ ) {
        	org.openXpertya.model.MUOMConversion rate = rates[ i ];
    ...
    static public BigDecimal getProductRateFrom( Properties ctx,int M_Product_ID,int C_UOM_To_ID ) {
    	org.openXpertya.model.MUOMConversion[] rates = getProductConversions( ctx,M_Product_ID,true );
    ...
    static public org.openXpertya.model.MUOMConversion[] getProductConversions( Properties ctx,int M_Product_ID) {
    ...
    static public org.openXpertya.model.MUOMConversion[] getProductConversions( Properties ctx,int M_Product_ID, boolean reload) {
        Integer          key    = new Integer( M_Product_ID );
        org.openXpertya.model.MUOMConversion[] result = ( org.openXpertya.model.MUOMConversion[] )s_conversionProduct.get( key );
        ...
        org.openXpertya.model.MUOMConversion defRate = new org.openXpertya.model.MUOMConversion( org.openXpertya.model.MProduct.get( ctx,M_Product_ID ));

        list.add( defRate );

        //

        String sql = "SELECT * FROM C_UOM_Conversion c " + "WHERE (c.M_Product_ID=? or c.M_Product_ID is null)" + " AND EXISTS (SELECT * FROM M_Product p " + "WHERE p.M_Product_ID=? AND c.C_UOM_ID=p.C_UOM_ID)" + " AND c.IsActive='Y'";
        PreparedStatement pstmt = null;
        ...
        try {
            ...
            while( rs.next()) {
                list.add( new org.openXpertya.model.MUOMConversion( ctx,rs,null ));
            }
        ...
        result = new org.openXpertya.model.MUOMConversion[ list.size()];
        list.toArray( result );
